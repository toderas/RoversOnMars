...
PWA_APP_START_URL = '/' 
PWA_APP_ICONS = [ { 'src': '/media/favicon.png', 'sizes': '160x160' } ] 
PWA_APP_ICONS_APPLE = [ { 'src': '/media/favicon.png', 'sizes': '160x160' } ] 
PWA_APP_SPLASH_SCREEN = [ { 'src': '/media/favicon.png', 'media': '(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)' } ] 
PWA_APP_DIR = 'ltr' 
PWA_APP_LANG = 'en-US'
